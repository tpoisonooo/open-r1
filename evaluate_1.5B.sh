...
MODEL_ARGS="pretrained=/home/khj/workspace/open-r1/data/Qwen2.5-1.5B-Open-R1-Distill,dtype=bfloat16,max_model_length=32768,gpu_memory_utilisation=0.8,tensor_parallel_size=2"
lighteval vllm $MODEL_ARGS "custom|gpqa:diamond|0|0" \
    --custom-tasks src/open_r1/evaluate.py \
    --use-chat-template \
    --output-dir data/evals/distill
